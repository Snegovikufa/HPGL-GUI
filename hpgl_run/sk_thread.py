...
class SKThread(QtCore.QThread):
    def __init__(self, Prop, GridObject, EllipsoidRanges, IntPoints, Variogram, SKMeanValue):
    ...
    def run(self):
        ...
        self.Result = simple_kriging( self.Prop, self.GridObject, self.EllipsoidRanges, 
                                      self.IntPoints, self.Variogram, self.SKMeanValue )
